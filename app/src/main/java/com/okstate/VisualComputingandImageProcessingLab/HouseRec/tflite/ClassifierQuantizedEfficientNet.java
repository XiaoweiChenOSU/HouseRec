...
public class ClassifierQuantizedEfficientNet extends Classifier {
   ...
   * @param activity
   */
  public ClassifierQuantizedEfficientNet(Activity activity, Device device, int numThreads,boolean myModel,String layoutname)
      throws IOException {
    super(activity, device, numThreads,false,layoutname);
  }
