...
public class ToDoItemBackup implements Serializable {
    ...
    public ToDoItemBackup(String todoBody, String tododescription, boolean hasReminder, Date toDoDate) {
        mToDoText = todoBody;
    ...
    public ToDoItemBackup(JSONObject jsonObject) throws JSONException {
...
//        jsonObject.put(TODOLASTEDITED, mLastEdited.getTime());
    ...
    public ToDoItemBackup(String TEXT_BODY, boolean hasReminder, Date CURRENT_DATE) {
