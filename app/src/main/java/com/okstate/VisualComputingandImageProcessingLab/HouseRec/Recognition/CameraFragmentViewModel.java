...
package com.okstate.VisualComputingandImageProcessingLab.HouseRec.Recognition;
...
public class CameraFragmentViewModel extends ViewModel {
  ...
  private MutableLiveData<Boolean> captureMode = new MutableLiveData<Boolean>(false);
  private MutableLiveData<Map<String, Float>> confidence = new MutableLiveData<Map<String, Float>>(new TreeMap<>());
  ...
  private MutableLiveData<TrainingState> trainingState =
      new MutableLiveData<TrainingState>(TrainingState.NOT_STARTED);
